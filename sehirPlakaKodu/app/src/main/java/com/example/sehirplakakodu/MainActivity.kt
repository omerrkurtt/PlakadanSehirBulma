    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener{
            if (binding.editTextNumber.text.isNotEmpty()){
                ...
                //editText in içerisindeki veriyi değişkene aktarıyoruz
                ...
                when(plakaKodu){
                    ...
                    82-> binding.textView.text="Musul"
                    83-> binding.textView.text="Kerkük"


                }
            }
            else{
                binding.textView.text = "Plaka Kodunu Giriniz..."
            }
